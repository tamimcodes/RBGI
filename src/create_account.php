...
<body>
    <section class="bg-background min-h-screen flex items-center justify-center">
        <div class="container max-w-3xl bg-secondary flex p-4 rounded-2xl shadow-2xl">
            <!--------------create in start left sidr --------------------->
            <div class="w-1/2 p-5">
                <h1 class="text-center text-3xl text-butBlue pb-2">Create Account</h1>
                
                <!----------form start---------------->
                <form action="signup_form.php" class="flex flex-col gap-2" method="POST">
                    ...
                    <input type="submit" name="submit" value="Create Account" class="bg-butBlue h-10 text-background rounded-md font-bold">
                </form>
                <!----------form end---------------->
                ...
                <div>
                    ...
                    <a href="login.php"><button class="text-butBlue">login ></button></a>
